...
class ConsumableStore {
  // A set to store the consumable items.
  static final Set<String> _consumableItems = HashSet<String>();

  // Load the consumable items from a data source.
  static Future<List<String>> load() async {
    return _consumableItems.toList();
  }

  // Save a consumable item.
  static Future<void> save(String id) async {
    // For example, you can save the consumable item to a database or a file.
    _consumableItems.add(id);
  }

  // Consume a consumable item.
  static Future<void> consume(String id) async {
    // For example, you can remove the consumable item from a database or a file.
    _consumableItems.remove(id);
  }
}
